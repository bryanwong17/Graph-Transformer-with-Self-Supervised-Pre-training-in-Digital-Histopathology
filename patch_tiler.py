...
def nested_patches(img_slide, out_base, level=(0,), ext='jpeg'):
    ...
    if len(level)==1:
        ...
        for i, patch in enumerate(patches):
            ...
            shutil.move(patch, os.path.join(bag_path, f'{img_name}-{patch_name}'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--dataset', type=str, default='D:/ML Dataset/TCGA/slide/test', help='Dataset name')
    ...
    for idx, c_slide in enumerate(all_slides):
        ...
        print('Process slide {}/{} | {}'.format(idx+1, len(all_slides), current_time))
        ...
        i += 1
    print('Patch extraction done for {} slides out of {} slides.'.format(i,len(all_slides)))