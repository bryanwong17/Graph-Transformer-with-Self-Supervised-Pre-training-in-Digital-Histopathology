...
#                            cp                                    last_epoch=-1)
        ...
        model_checkpoints_folder = os.path.join('../../graph_transformer/runs/simclr', self.writer.log_dir)
    ...
    def _load_pre_trained_weights(self, model):
        try:
            checkpoints_folder = os.path.join('../../graph_transformer/runs/simclr/runs', self.config['fine_tune_from'])
