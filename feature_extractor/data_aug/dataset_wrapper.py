...
class DataSetWrapper(object):
    ...
    def get_data_loaders(self):
        ...
        train_dataset = Dataset(csv_file='D:/MedicalAI/dataset/TCGA/TCGA_512_train_sample_3000.csv', transform=SimCLRDataTransform(data_augment))
        valid_dataset = Dataset(csv_file='D:/MedicalAI/dataset/TCGA/TCGA_512_train_sample_3000.csv', transform=SimCLRDataTransform(data_augment))
        ...
        # valid_dataset = Dataset(csv_file='new_val_temp.csv', transform=MocoV3fDataTransform(data_augment_1, data_augment_2))

        #########################################################################################################################

        # apply SiamSiam transformation to dataset
        # MoCo v2's aug: similar to SimCLR https://arxiv.org/abs/2002.05709
        # data_augment = self.get_simsiam_transform()
        # train_dataset = Dataset(csv_file='D:/MedicalAI/dataset/TCGA/TCGA_train_random_sample_3000.csv', transform=SimSiamDataTransform(data_augment))
        # valid_dataset = Dataset(csv_file='D:/MedicalAI/dataset/TCGA/TCGA_val_random_sample_3000.csv', transform=SimSiamDataTransform(data_augment))
    ...
    def get_simsiam_transform(self):
        ...
        data_transforms = transforms.Compose(augmentation)
        return data_transforms
...
class SimSiamDataTransform(object):
