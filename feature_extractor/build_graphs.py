...
def compute_feats(args, bags_list, i_classifier, save_path=None, whole_slide_path=None):
    ...
    for i in range(0, num_bags):
        ...
        full_path = glob.glob(os.path.join(bags_list[i], '*.jpeg'))
...
def main():
    ...
    parser.add_argument('--dataset', default="E:/sample_3000", type=str, help='path to patches')
    ...
    parser.add_argument('--weights', default='../../graph_transformer/runs/simsiam/runs/tcga_resnet50_not_pretrained_new_3000/model.pth', type=str, help='path to the pretrained weights')
    parser.add_argument('--output', default='../../graph_transformer/build_graphs/simsiam/graphs_tcga_resnet50_not_pretrained_new_3000', type=str, help='path to the output graph folder')
    ...
    for _class in CLASSES:
        for subset in SUBSET:
            bags_list = bags_list + glob.glob(os.path.join(args.dataset, subset, _class, "*"))
