...
class Options():
    def __init__(self):
        ...
        parser.add_argument('--data_path', type=str, default="../graph_transformer/build_graphs/simclr/graphs_tcga_resnet50_pretrained_new_3000/simclr_files", help='path to dataset where images store')
        ...
        parser.add_argument('--model_path', type=str, default="../graph_transformer/results_with_graph/simclr/tcga_resnet50_pretrained_new_3000_4/saved_models", help='path to trained model')
        parser.add_argument('--log_path', type=str, default="../graph_transformer/results_with_graph/simclr/tcga_resnet50_pretrained_new_3000_4/runs", help='path to log files')
        ...
        parser.add_argument('--figure_path', type=str, default="../graph_transformer/results_with_graph/simclr/tcga_resnet50_pretrained_new_3000_4/curve", help='GraphCAM')
